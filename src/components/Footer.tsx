  ...
  return (
    <footer className="bg-primary text-primary-foreground py-12">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-primary-foreground/80 mb-6 max-w-md">
              Global talent solutions delivered with local expertise. 
              We connect organizations with exceptional talent across industries.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-primary-light rounded-lg flex items-center justify-center hover:bg-accent transition-smooth">
        ...
        <div className="border-t border-primary-light mt-8 pt-8 text-center text-primary-foreground/60">
          <p>&copy; 2024 Talent Fino. All rights reserved. | Global Talent Solutions, Delivered with Local Expertise</p>
        </div>
      </div>
    </footer>
  );
